# Document how to deploy basic employee_file_manager_php
# 1. Tạo Ứng Dụng Web PHP
Tạo một ứng dụng web PHP đơn giản có lỗ hổng upload tệp tin:
**File: `index.php`**
``` <!DOCTYPE html>
<html lang="en">
<head>
...
```
## 2. Tạo một file Dockerfile
Tạo một Dockerfile để chạy ứng dụng PHP:
```
FROM php:7.4-apache
COPY . /var/www/html/
...
```
docker build -t php-upload-test .
docker run -d -p 8080:80 php-upload-test
```
